...
class SweatersSection extends StatefulWidget {
  const SweatersSection({super.key});

  @override
  State<SweatersSection> createState() => _SweatersSectionState();
}

class _SweatersSectionState extends State<SweatersSection> {
  ...
  final List<Map<String, dynamic>> _products = [
    ...
    },
    {
      ...
      'image': 'https://images.unsplash.com/photo-1576871337632-f9d46b139ef5?w=400&q=80',
      'originalPrice': 89.99,
      'discountPrice': 64.99,
      'rating': 4.5,
      'reviews': 156,
    ...
    {
      'name': 'V-Neck Sweater',
      'image': 'https://images.unsplash.com/photo-1607344645866-009e20e3d07e?w=400&q=80',
      'originalPrice': 59.99,
      'discountPrice': 44.99,
      'rating': 4.6,
      'reviews': 312,
