...
class AppColors {
  ...
  static const Color primaryGold = Color(0xFFAA148B);// Classic Gold
  static const Color primaryGoldDark = Color(0xFFAA148B); // Darker Gold
  static const Color primaryGoldLight = Color(0xFFD35ABC); // Light Gold
  ...
  // Background Colors
  static const Color backgroundBlack = Color(0xFFAA148B);
  static const Color backgroundDarkGray = Color(0xFF8A0E6F);
  static const Color backgroundMediumGray = Color(0xFFD35ABC);
  ...
  // Primary Theme Colors (Purple based on UI image)
  static const Color primaryPurple = Color(0xFFAA148B);
  static const Color primaryPurpleDark = Color(0xFF8A0E6F);
  static const Color primaryPurpleLight = Color(0xFFD35ABC);
  static const Color primaryPurpleVeryLight = Color(0xFFFCE9F1);
  static const Color onboardingPink = Color(0xFFFCE9F1);
